...
tv_ads <- read_dta("../data/wmp-coded/tvads_kantar_cmag.dta") 
colnames(tv_ads)
...
* We’d prefer you to rely on WMP coding variables. They are labeled in the data set and are outlined in the attached Excel codebook.
...
ggsave("../output/tv_ads_breakdown.png", width = 7, height = 4.5)
